...
class OrderController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('order.show', compact('id', 'data', 'pageTitle', 'complate_data', 'courierCompany', 'trackingId', 'is_vehicle_in_order','mediaItems'));
    }
    /**
    ...
    public function multipleLabel(Request $request)
    {
        ...
        return view('order.multiplelabel', compact('orders', 'barcodeBase64', 'companyName', 'companynumber', 'companyAddress', 'invoice'));
    }
    ...
    public function getOrderDetails($id)
    {
        ...
        return compact('order', 'barcodeBase64', 'companyName', 'companynumber', 'companyAddress', 'invoice', 'id');
    }
    ...
    public function printOrderMultiple(Request $request)
    {
        ...
        return view('order.multipleprint', compact('orders', 'companyName', 'companyNumber', 'barcodeBase64'));
    }
    public function getOrderDetailsQrcode($id)
    {
        ...
        return compact('order', 'barcodeBase64', 'companyName', 'companynumber', 'id', 'invoice');
    }
