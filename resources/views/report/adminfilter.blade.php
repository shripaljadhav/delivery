<div class="card-body">
    {{ Form::open(['method' => 'GET', 'route' => 'report-adminEarning', 'id' => 'filter-form']) }}
        <div class="row justify-content-end align-items-end">
            <div class="form-group col-auto">
                ...
                {{ Form::date('from_date', $params['from_date'] ?? request('from_date') , ['placeholder' => __('message.date'), 'class' => 'form-control datepicker select2Clear', 'id' => 'from_date_main']) }}
            </div>
            <div class="form-group col-auto">
                ...
                {{ Form::date('to_date', $params['to_date'] ?? request('to_date') , ['placeholder' => __('message.date'), 'class' => 'form-control datepicker select2Clear', 'id' => 'to_date_main']) }}
            </div>
            <div class="form-group col-sm-0">
                <button type="submit" class="btn btn-sm btn-primary text-white pt-2 pb-2 clearListPropertynumber">{{ __('message.apply_filter') }}</button>
            </div>
