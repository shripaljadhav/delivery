<x-master-layout :assets="$assets ?? []">
    <div>
        <?php $id = $id ?? null;?>
        @if(isset($id))
            {!! Form::model($data, ['route' => ['deliveryman.update', $id], 'method' => 'patch', 'id' => 'deliveryman_form']) !!}
        @else
            {!! Form::open(['route' => ['deliveryman.store'], 'method' => 'post', 'id' => 'deliveryman_form']) !!}
        @endif
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <div class="new-user-info">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {{ Form::text('email',isset($id) ? optional($data)->email : old('email'),[ 'placeholder' => __('message.email'),'class' =>'form-control','required',$readonly]) }}
                                </div>
