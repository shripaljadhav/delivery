<?php $id = $id ?? null; ?>
@if (isset($id))
    {{ Form::model($data, ['route' => ['clientreview.update', $id], 'method' => 'patch','enctype' => 'multipart/form-data']) }}
@else
    {{ Form::open(['route' => ['clientreview.store'], 'method' => 'post','enctype' => 'multipart/form-data']) }}
@endif
{!! Form::hidden('type', 'client_review') !!}
<div class="modal-dialog modal-dialog-centered modal-xl" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group col-md-12">
                {{ Form::label('subtitle', __('message.email') . ' <span class="text-danger">*</span>', ['class' => 'form-control-label'], false) }}
                {{ Form::text('subtitle', old('subtitle'), ['placeholder' => __('message.email'), 'class' => 'form-control', 'required']) }}
